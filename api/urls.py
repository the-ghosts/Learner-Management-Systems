...
urlpatterns = [
    ...
    path("user/password-reset/<email>/", api_views.ResetPasswordEmailVerifyApiView.as_view()),
    path("user/password-change/", api_views.PasswordChangeAPIView.as_view()),

    #api models Endpoint
    path("course/category/", api_views.CategoryListAPIView.as_view()),
    path("course/course-list/", api_views.CourseListAPIView.as_view()),
    path("course/course-detail/<slug>/", api_views.CourseDetailListAPIView.as_view()),
    ...
    path("cart/stats/<cart_id>/", api_views.CartStatAPIView.as_view()),
    ...
    path("payment/payment-success/", api_views.PaymentSuccessAPIViews.as_view()),
    path("course/search/", api_views.SearchCourseAPIViews.as_view()),
]
